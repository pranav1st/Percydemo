...
var UploadService = function () {
    ...
    var UploadService = _classThis = /** @class */ (function () {
        function UploadService_1(configurationService, loggerService, httpService) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            instance = new upload_provider_aws_1.UploadProviderAws(this.loggerService, this.configurationService, this.httpService);
