...
var AlertBySiemSolutionController = function () {
    ...
    var AlertBySiemSolutionController = _classThis = /** @class */ (function () {
        function AlertBySiemSolutionController_1(siemSolutionDomainFacade, alertDomainFacade, eventService, authenticationDomainFacade) {
        ...
        AlertBySiemSolutionController_1.prototype.findManySiemSolutionId = function (siemSolutionId, request) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            parent = _a.sent();
                            return [4 /*yield*/, this.alertDomainFacade.findManyBySiemSolution(parent, queryOptions)];
                        case 2:
                            items = _a.sent();
        ...
        AlertBySiemSolutionController_1.prototype.createBySiemSolutionId = function (siemSolutionId, body, request) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.alertDomainFacade.create(valuesUpdated)];
                        case 1:
                            item = _a.sent();
        ...
        return AlertBySiemSolutionController_1;
    }());
    __setFunctionName(_classThis, "AlertBySiemSolutionController");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _findManySiemSolutionId_decorators = [(0, common_1.Get)('/siemSolution/:siemSolutionId/alerts')];
        _createBySiemSolutionId_decorators = [(0, common_1.Post)('/siemSolution/:siemSolutionId/alerts')];
        ...
        AlertBySiemSolutionController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return AlertBySiemSolutionController = _classThis;
}();
exports.AlertBySiemSolutionController = AlertBySiemSolutionController;
