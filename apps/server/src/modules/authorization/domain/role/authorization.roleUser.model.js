...
var authorization_role_model_1 = require("./authorization.role.model");
var AuthorizationRoleUser = function () {
    ...
    var AuthorizationRoleUser = _classThis = /** @class */ (function () {
        function AuthorizationRoleUser_1() {
        ...
        return AuthorizationRoleUser_1;
    }());
    __setFunctionName(_classThis, "AuthorizationRoleUser");
    (function () {
        ...
        _roleId_decorators = [(0, typeorm_1.PrimaryColumn)()];
        _role_decorators = [(0, typeorm_1.ManyToOne)(function () { return authorization_role_model_1.AuthorizationRole; }), (0, typeorm_1.JoinColumn)({ name: 'roleId' })];
        ...
        AuthorizationRoleUser = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return AuthorizationRoleUser = _classThis;
}();
