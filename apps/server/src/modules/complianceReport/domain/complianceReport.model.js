...
var ComplianceReport = function () {
    ...
    var ComplianceReport = _classThis = /** @class */ (function () {
        function ComplianceReport_1() {
            this.id = (__runInitializers(this, _instanceExtraInitializers), __runInitializers(this, _id_initializers, void 0));
            this.reportDetails = __runInitializers(this, _reportDetails_initializers, void 0);
        ...
        return ComplianceReport_1;
    }());
    __setFunctionName(_classThis, "ComplianceReport");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _id_decorators = [(0, typeorm_1.PrimaryGeneratedColumn)('uuid')];
        _reportDetails_decorators = [(0, typeorm_1.Column)({ nullable: true })];
        _customizations_decorators = [(0, typeorm_1.Column)({ nullable: true })];
        _status_decorators = [(0, typeorm_1.Column)({ nullable: true })];
        _siemSolutionId_decorators = [(0, typeorm_1.Column)({ nullable: true })];
        _siemSolution_decorators = [(0, typeorm_1.ManyToOne)(function () { return domain_1.SiemSolution; }, function (parent) { return parent.complianceReports; }), (0, typeorm_1.JoinColumn)({ name: 'siemSolutionId' })];
        ...
        ComplianceReport = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ComplianceReport = _classThis;
}();
