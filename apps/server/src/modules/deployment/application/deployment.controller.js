...
var DeploymentController = function () {
    var _classDecorators = [(0, common_1.Controller)('/v1/deployments')];
    ...
    var DeploymentController = _classThis = /** @class */ (function () {
        function DeploymentController_1(eventService, deploymentDomainFacade, authenticationDomainFacade) {
        ...
        DeploymentController_1.prototype.findMany = function (request) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.deploymentDomainFacade.findMany(queryOptions)];
                        case 1:
                            items = _a.sent();
        ...
        DeploymentController_1.prototype.create = function (body, request) {
            return __awaiter(this, void 0, void 0, function () {
                var user, item;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.deploymentDomainFacade.create(body)];
                        case 1:
                            item = _a.sent();
        ...
        DeploymentController_1.prototype.findOne = function (deploymentId, request) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            queryOptions = request_1.RequestHelper.getQueryOptions(request);
                            return [4 /*yield*/, this.deploymentDomainFacade.findOneByIdOrFail(deploymentId, queryOptions)];
                        case 1:
                            item = _a.sent();
                            return [2 /*return*/, item];
                    }
        ...
        DeploymentController_1.prototype.update = function (deploymentId, body) {
            return __awaiter(this, void 0, void 0, function () {
                var item, itemUpdated;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.deploymentDomainFacade.findOneByIdOrFail(deploymentId)];
                        case 1:
                            item = _a.sent();
                            return [4 /*yield*/, this.deploymentDomainFacade.update(item, body)];
                        case 2:
                            itemUpdated = _a.sent();
        ...
        DeploymentController_1.prototype.delete = function (deploymentId) {
            return __awaiter(this, void 0, void 0, function () {
                var item;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            item = _a.sent();
                            return [4 /*yield*/, this.deploymentDomainFacade.delete(item)];
                        case 2:
                            _a.sent();
                            return [2 /*return*/, item];
                    }
        ...
        return DeploymentController_1;
    }());
    __setFunctionName(_classThis, "DeploymentController");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _findMany_decorators = [(0, common_1.Get)('/')];
        _create_decorators = [(0, common_1.Post)('/')];
        _findOne_decorators = [(0, common_1.Get)('/:deploymentId')];
        _update_decorators = [(0, common_1.Patch)('/:deploymentId')];
        _delete_decorators = [(0, common_1.Delete)('/:deploymentId')];
        ...
        DeploymentController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return DeploymentController = _classThis;
}();
