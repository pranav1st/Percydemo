...
var Deployment = function () {
    ...
    var Deployment = _classThis = /** @class */ (function () {
        function Deployment_1() {
            ...
            this.configurationDetails = __runInitializers(this, _configurationDetails_initializers, void 0);
    ...
    (function () {
        ...
        _configurationDetails_decorators = [(0, typeorm_1.Column)({ nullable: true })];
        _status_decorators = [(0, typeorm_1.Column)({ nullable: true })];
        _siemSolutionId_decorators = [(0, typeorm_1.Column)({ nullable: true })];
        _siemSolution_decorators = [(0, typeorm_1.ManyToOne)(function () { return domain_1.SiemSolution; }, function (parent) { return parent.deployments; }), (0, typeorm_1.JoinColumn)({ name: 'siemSolutionId' })];
