...
var notification_domain_facade_1 = require("./notification.domain.facade");
var notification_model_1 = require("./notification.model");
var NotificationDomainModule = function () {
    ...
    var _classThis;
    var NotificationDomainModule = _classThis = /** @class */ (function () {
        function NotificationDomainModule_1() {
        }
        return NotificationDomainModule_1;
    }());
    __setFunctionName(_classThis, "NotificationDomainModule");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        NotificationDomainModule = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return NotificationDomainModule = _classThis;
}();
