...
var ResourceAllocation = function () {
    ...
    var ResourceAllocation = _classThis = /** @class */ (function () {
        function ResourceAllocation_1() {
            this.id = (__runInitializers(this, _instanceExtraInitializers), __runInitializers(this, _id_initializers, void 0));
            this.resourceDetails = __runInitializers(this, _resourceDetails_initializers, void 0);
        ...
        return ResourceAllocation_1;
    }());
    __setFunctionName(_classThis, "ResourceAllocation");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _id_decorators = [(0, typeorm_1.PrimaryGeneratedColumn)('uuid')];
        _resourceDetails_decorators = [(0, typeorm_1.Column)({ nullable: true })];
        _scalabilityReview_decorators = [(0, typeorm_1.Column)({ nullable: true })];
        _siemSolutionId_decorators = [(0, typeorm_1.Column)({ nullable: true })];
        _siemSolution_decorators = [(0, typeorm_1.ManyToOne)(function () { return domain_1.SiemSolution; }, function (parent) { return parent.resourceAllocations; }), (0, typeorm_1.JoinColumn)({ name: 'siemSolutionId' })];
