...
var SecurityEvent = function () {
    ...
    var SecurityEvent = _classThis = /** @class */ (function () {
        function SecurityEvent_1() {
            this.id = (__runInitializers(this, _instanceExtraInitializers), __runInitializers(this, _id_initializers, void 0));
            this.eventDetails = __runInitializers(this, _eventDetails_initializers, void 0);
        ...
        return SecurityEvent_1;
    }());
    __setFunctionName(_classThis, "SecurityEvent");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _id_decorators = [(0, typeorm_1.PrimaryGeneratedColumn)('uuid')];
        _eventDetails_decorators = [(0, typeorm_1.Column)({ nullable: true })];
        _timestamp_decorators = [(0, typeorm_1.Column)({ nullable: true })];
        _siemSolutionId_decorators = [(0, typeorm_1.Column)({ nullable: true })];
        _siemSolution_decorators = [(0, typeorm_1.ManyToOne)(function () { return domain_1.SiemSolution; }, function (parent) { return parent.securityEvents; }), (0, typeorm_1.JoinColumn)({ name: 'siemSolutionId' })];
        ...
        SecurityEvent = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return SecurityEvent = _classThis;
}();
