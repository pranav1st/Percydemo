...
var SupportBySiemSolutionController = function () {
    ...
    var SupportBySiemSolutionController = _classThis = /** @class */ (function () {
        function SupportBySiemSolutionController_1(siemSolutionDomainFacade, supportDomainFacade, eventService, authenticationDomainFacade) {
        ...
        SupportBySiemSolutionController_1.prototype.findManySiemSolutionId = function (siemSolutionId, request) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            parent = _a.sent();
                            return [4 /*yield*/, this.supportDomainFacade.findManyBySiemSolution(parent, queryOptions)];
                        case 2:
                            items = _a.sent();
        ...
        SupportBySiemSolutionController_1.prototype.createBySiemSolutionId = function (siemSolutionId, body, request) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.supportDomainFacade.create(valuesUpdated)];
                        case 1:
                            item = _a.sent();
        ...
        return SupportBySiemSolutionController_1;
    }());
    __setFunctionName(_classThis, "SupportBySiemSolutionController");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _findManySiemSolutionId_decorators = [(0, common_1.Get)('/siemSolution/:siemSolutionId/supports')];
        _createBySiemSolutionId_decorators = [(0, common_1.Post)('/siemSolution/:siemSolutionId/supports')];
        ...
        SupportBySiemSolutionController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return SupportBySiemSolutionController = _classThis;
}();
exports.SupportBySiemSolutionController = SupportBySiemSolutionController;
