...
var Support = function () {
    ...
    var Support = _classThis = /** @class */ (function () {
        function Support_1() {
            this.id = (__runInitializers(this, _instanceExtraInitializers), __runInitializers(this, _id_initializers, void 0));
            this.supportDetails = __runInitializers(this, _supportDetails_initializers, void 0);
    ...
    __setFunctionName(_classThis, "Support");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _id_decorators = [(0, typeorm_1.PrimaryGeneratedColumn)('uuid')];
        _supportDetails_decorators = [(0, typeorm_1.Column)({ nullable: true })];
        _status_decorators = [(0, typeorm_1.Column)({ nullable: true })];
        _siemSolutionId_decorators = [(0, typeorm_1.Column)({ nullable: true })];
        _siemSolution_decorators = [(0, typeorm_1.ManyToOne)(function () { return domain_1.SiemSolution; }, function (parent) { return parent.supports; }), (0, typeorm_1.JoinColumn)({ name: 'siemSolutionId' })];
